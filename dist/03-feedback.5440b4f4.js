...
function hendlerInputForm({ target  }) {
    ...
    let localData = (0, _storage.load)(KEY) || {};
    localData[name] = value;
    (0, _storage.save)(KEY, localData);
}
function hendlerSavedata(e) {
    ...
    feedBackForm.reset();
    (0, _storage.remove)(KEY);
}
function resetForm() {
    if (localStorage.getItem(KEY)) Object.entries((0, _storage.load)(KEY)).forEach(([key, value])=>{
        feedBackForm.elements[key].value = value;
    });
}
feedBackForm.addEventListener("input", (0, _lodashThrottleDefault.default)(hendlerInputForm, 1000));
feedBackForm.addEventListener("submit", hendlerSavedata);

},{"lodash.throttle":"bGJVT","./storage":"h0qAZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bGJVT":[function(require,module,exports) {
var global = arguments[3];
/**
